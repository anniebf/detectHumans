...
SUSPEITA_FRAMES_MIN = 15    # Exige cerca de 1 a 2 segundos de persistência no chão antes de suspeitar
LIMIAR_EM_PE = 1.05        # Se for menor que 1.40, já deixa de ser considerado "Em Pé" normal
